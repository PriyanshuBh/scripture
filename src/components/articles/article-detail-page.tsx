        ...
        <article className="mx-auto max-w-3xl">
          ...
          <header className="mb-12">
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="rounded-full bg-primary/10 px-3 py-1 text-sm text-primary  cursor-pointer ">
              <Link className="inline-flex items-center gap-1" href="/articles">
              <ArrowLeft/>  Back
              </Link>
          ...
          {/* Article Content */}
          <div className="flex flex-wrap gap-2 mb-4">
              <span className="rounded-full bg-primary/10 px-3 py-1 text-sm text-primary  cursor-pointer capitalize">
